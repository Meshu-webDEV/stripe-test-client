...
const body = {
  user: {
    full_name: 'Meshari',
    email: 'MeshariattempterToken@k.com',
    mobile: '971582820105',
    password: '1qaz2wsx',
...
const ProductDisplay = () => {
  ...
  const handleCheckout = async (e) => {
    try {
      ...
      backendAPI.defaults.baseURL = 'http://localhost:6060/v1/client/leads/order/checkout/initiate/40719e0f-15bc-4683-8e0d-aadd7c3ae2f6';
      // backendAPI.defaults.baseURL
      await backendAPI.post('/', body);
    } catch (error) {
      console.log(error);
    }
  };
  ...
  return (
    <section>
      ...
      <form>
        ...
        <button className='text-black bg-slate-200' id='checkout-and-portal-button' type='submit' onClick={handleCheckout}>
          Checkout
        </button>
      </form>
    </section>
